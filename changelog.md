...
* Now using Java 17
* Renamed plugin to ``more-commands``
...
* API friendly modules: You can now expend this plugin to add more modules to the ``ModuleRegistry`` or custom rules to the ``Gatekeeper``.
...
* Added more commands
* Adapted plugin to Mindustry v159.6
