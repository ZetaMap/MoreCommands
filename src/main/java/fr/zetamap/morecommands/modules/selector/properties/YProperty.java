...
/** Accepted formats: {@code y=5} (normal y) or {@code y=5w} (world scaled y: {@code 5*8=40}). */
public class YProperty extends SelectorProperty {
  public YProperty() { super(Category.positioning); }
  ...
  public class Parsed extends SelectorProperty.Parsed {
    ...
    public Parsed(float y) { this.y = y; }
