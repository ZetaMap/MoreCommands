...
public class RangeParser {
  public static Range<Integer> parseInt(String input, boolean notNegative) throws ParseException {
    return parseInt(new StringReader(input), notNegative);
  }
  public static Range<Integer> parseInt(StringReader reader, boolean notNegative) throws ParseException {
  ...
  public static Range<Float> parseFloat(String input, boolean notNegative) throws ParseException {
    return parseFloat(new StringReader(input), notNegative);
  }
  public static Range<Float> parseFloat(StringReader reader, boolean notNegative) throws ParseException {
    reader.skipWhitespaces();
